...
def site_login():
	...
	driver.find_element_by_name("email").send_keys("javespmeg@gmail.com")
	driver.find_element_by_name("password").send_keys("@Chester@Field1H")
...
async def on_voice_state_update(member, before, after):
	if before.channel is None and after.channel is not None:
		before.channel.play(discord.FFmpegPCMAudio('/roger.mp3'), after=lambda e: print('said Hi', e))
